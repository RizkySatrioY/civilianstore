...
include 'db.php';
$ambildata = mysqli_query($conn, "SELECT * FROM tb_product WHERE product_id = '" .$_GET['idp']."'");
                                ...
                                <div class="col-md-12">
                                    <form method = "POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="nama" value="<?php echo $a->product_nama ?>"/>
                                        </div>

                                        <div class="form-group">
                                            <label>Deskripsi</label>
                                            <textarea class="form-control" name="deskripsi" value="<?php echo $a->product_deskripsi?>"></textarea>
                                            </div>

                                        <div class="form-group">
                                            <label>Harga</label>
                                            <input class="form-control" name="harga" value="<?php echo $a->product_harga ?>"/>
                                        </div>

                                        <div class="form-group">
                                            <label>Gambar</label>
                                            <input type="file" name="gambar" value="<?php echo $a->product_gambar ?>"/>
                                        </div>
