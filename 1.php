...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Admin Civilian</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <a href="1.php" class="nav-link active">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <li class="nav-item">
                <a href="datapemesan.php" class="nav-link">
              ...
              <a href="notif.php" class="nav-link active">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
              ...
              <div class="inner">
                <h3><?php echo $tampil['total_baju']?></h3>
                <?php }}?>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?=$count3;?><sup style="font-size: 20px"></sup></h3>

                <p>Sudah Melakukan Transaksi</p>
              </div>
              <div class="icon">
