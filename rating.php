...
<section class="products" id="products">
    ...
    <h1 class="heading"> Product <span>Review</span> </h1><br>
...
<link rel="stylesheet" href="css/style.css">
 ...
 <body>
  <h2 align="center"><a href="">Tulis Komentar</a></h2>
  <div class="container">
   <form method="POST" id="comment_form">
    <div class="form-group">
     <input type="text" name="comment_name" id="comment_name" class="form-control" placeholder="Masukkan Nama" autocomplete="off"/>
    </div>
    <div class="form-group">
     <textarea name="comment_content" id="comment_content" class="form-control" placeholder="Masukkan komentar dan Rating Bintang Kalian" rows="5"></textarea>
    </div>
    <div class="form-group">
...
<section class="footer">
    ...
    <div class="share">
        ...
        <a href="https://wa.me/6281230530792/" class="fa fa-address-book"></a>
